...
#There was no relationship between risk taking and gender, t(78) = 0.45, p = .66, CHECK

#bicycling experience (ρ = .12, p = .27) CHECK

#and extent of helmet use when bicycling (ρ = .06, p = .60) CHECK
